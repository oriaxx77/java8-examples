...
/**
 * A banking example with synchronization.
 * Two person tries to use the same account.
 * @author BagyuraI
 */
public class BankingExampleWithSynch
{
	...
	private static class Account
	{
		 ...
		 */
		public synchronized void deduct( float amount, int sleepMillis) throws InvalidAmountException
		{
